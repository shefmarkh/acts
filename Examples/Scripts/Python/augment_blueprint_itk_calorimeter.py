...
if "__main__" == __name__:
    ...
    # Set the blueprint table name
    BlueprintTable = args.table_name
    ...
    print(f">> Creating new table called {BlueprintTable}")

    volCount = 0

    volCount += 1
    cursor.execute(
        f"CREATE TABLE {BlueprintTable}(id INT, type TEXT, name TEXT, bounds TEXT, internals TEXT, binnings TEXT, materials TEXT)"
    )
    ...
    # Material binning
    IP_b_mat_z_bins = 150
    IP_b_mat_phi_bins = 64

    IP_iec_mat_z_bins = 150
    IP_iec_mat_r_bins = 50
    IP_iec_mat_phi_bins = 64

    IP_ec_mat_z_bins = 150
    IP_ec_mat_r_bins = 50
    IP_ec_mat_phi_bins = 64
    ...
    OP_incl_mat_z_bins = 150
    OP_incl_mat_r_bins = 10
    OP_incl_mat_phi_bins = 1

    OP_ec_mat_z_bins = 150
    OP_ec_mat_r_bins = 10
    OP_ec_mat_phi_bins = 1
    ...
    Calo_r_max = 3632.00 #looping over all DDE in TileBar2, TileGap2 and Tile Ext2 in Athena shows the maximal value of r is 3630.00
    Calo_r_min = 1450 #looping over all DDE in preSamplerB in Athena shows the minimal value of r is 1452.46

    Calo_preSamplerB_r_max = 1462.00 #looping over all DDE in preSamplerB in Athena shows the maximal value of r is 1460.87

    volCount += 1
    cursor.execute(
        f"""
    INSERT INTO {BlueprintTable} VALUES
            ({volCount},
            'container:200',
            'ATLAS',
            'cyl,0,{Calo_r_max},-{ITk_z_max},{ITk_z_max}',
            'children:container:110,container:300',
            'r',
            '')
    """
    )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'container:300',
            'Calorimeter',
            'cyl,{Calo_r_min},{Calo_r_max},-{ITk_z_max},{ITk_z_max}',
            'childern:container:310',
            'r',
            '')
    """
    )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'container:310',
            'preSamplerB',
            'cyl,{Calo_r_min},{Calo_preSamplerB_r_max},-{ITk_z_max},{ITk_z_max}',
            '',
            'r',
            '')
    """
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            '',
            '', 
            'p2:z,bound,{BP_mat_z_bins},0,*,*;phi,closed,1,0,*,*')
    """
    )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            '',
            '',
            'p0:r,bound,50,0,*,*;phi,closed,32,0,*,*')
    """
    )
    volCount += 1
    cursor.execute(
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            '',
            '', 
            'p1:r,bound,50,0,*,*;phi,closed,32,0,*,*')
    """
    )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'r',
            'p2:z,bound,250,0,*,*;phi,closed,1,0,*,*')
    """
    )
    volCount += 1
    cursor.execute(
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'p3:z,bound,{S_b_mat_z_bins},0,*,*;phi,closed,{S_b_mat_phi_bins},0,*,*')
    """
    )
    ...
    # p3:z,bound,{S_ec_mat_z_bins},0,*,*;phi,closed,{S_ec_mat_phi_bins},0,*,*
   ...
   # Endcap Layers
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'p1:r,bound,{S_ec_mat_r_bins},0,*,*;phi,closed,{S_ec_mat_phi_bins},0,*,*')
        """
        )
   ...
   # Barrel Layers
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'layer:kdt,cyl,e,e,{S_ec_searchsplits[i-1]},{sp}',
            'r,bound,12,1;phi,closed,64,1', 
            'p0:r,bound,{S_ec_mat_r_bins},0,*,*;phi,closed,{S_ec_mat_phi_bins},0,*,*')
    """
    )
    ...
    #p2:z,bound,{OP_ec_mat_z_bins},0,*,*;phi,closed,{OP_ec_mat_phi_bins},0,*,*
    ...
    for i,sp in enumerate(OP_ec_ring0_searchsplits):
        ...
        volCount += 1
        cursor.execute(
        f"""INSERT INTO {BlueprintTable} VALUES
            ({volCount}, 
            'leaf',
            ...
            'p0:r,bound,{OP_ec_mat_r_bins},0,*,*;phi,closed,{OP_ec_mat_phi_bins},0,*,*')
        """
        )
   ...
   # p2:z,bound,{OP_incl_mat_z_bins},0,*,*;phi,closed,{OP_incl_mat_phi_bins},0,*,*
   ...
   # Inclined Layers
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'p0:r,bound,{OP_incl_mat_r_bins},0,*,*;phi,closed,{OP_incl_mat_phi_bins},0,*,*')
        """
        )
   ...
   # Inclined Layers
    ...
    for i,sp in enumerate(OP_ec_ring0_searchsplits):
        ...
        INSERT INTO {BlueprintTable} VALUES
            ...
            'layer:kdt,cyl,e,e,{OP_ec_ring0_searchsplits[i-1]},{sp}',
            'phi,closed,{OP_ec_phi_bins[0]},1',   
            'p1:r,bound,{OP_ec_mat_r_bins},0,*,*;phi,closed,{OP_ec_mat_phi_bins},0,*,*')
        """
        )
    ...
    # p2:z,bound,{OP_ec_mat_z_bins},0,*,*;phi,closed,{OP_incl_mat_phi_bins},0,*,*
    ...
    for i,sp in enumerate(OP_incl_ring0_searchsplits):
      ...
      INSERT INTO {BlueprintTable} VALUES
            ...
            'layer:kdt,cyl,e,e,{OP_incl_ring0_searchsplits[i-1]},{sp}',
            'phi,closed,{OP_incl_phi_bins[0]},1',   
            'p1:r,bound,{OP_incl_mat_r_bins},0,*,*;phi,closed,{OP_incl_mat_phi_bins},0,*,*')
        """
        )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'phi,closed,30,1', 
            'p0:r,bound,{IP_ec_mat_r_bins},0,*,*;phi,closed,{IP_ec_mat_phi_bins},0,*,*')
        """
        )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'p0:r,bound,{IP_iec_mat_r_bins},0,*,*;phi,closed,{IP_iec_mat_phi_bins},0,*,*')
        """
        )  
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'p2:z,bound,{IP_b_mat_z_bins},0,*,*;phi,closed,{IP_b_mat_phi_bins},0,*,*')
    """
    )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'layer:kdt,cyl,e,e,{IP_iec_searchsplits[i-1]},{sp}',
            'r,bound,2,1;phi,closed,20,1',  
             'p1:r,bound,{IP_iec_mat_r_bins},0,*,*;phi,closed,{IP_iec_mat_phi_bins},0,*,*')
        """
        )
    ...
    INSERT INTO {BlueprintTable} VALUES
            ...
            'layer:kdt,cyl,e,e,{IP_ec_searchsplits[i-1]},{sp}',
            'phi,closed,30,1', 
            'p1:r,bound,{IP_ec_mat_r_bins},0,*,*;phi,closed,{IP_ec_mat_phi_bins},0,*,*')
        """
        )
